...
import com.hyundairoad.hyundairoad.global.utils.RedisUtil;
import com.hyundairoad.hyundairoad.member.exception.InvalidMimeMailException;
import com.hyundairoad.hyundairoad.member.exception.InvalidSimpleMailException;
...
import static com.hyundairoad.hyundairoad.constants.ErrorMsg.INVALID_MIME_MAIL_SEND;
import static com.hyundairoad.hyundairoad.constants.ErrorMsg.INVALID_SIMPLE_MAIL_SEND;
...
public class MailSendService {
    ...
    private void simpleMailSend(String email) {
        ...
        try {
            ...
            throw new InvalidSimpleMailException(INVALID_SIMPLE_MAIL_SEND);
        }
    }
    ...
    private void mimeMailSend(String setFrom, String toMail, String title, String content) {
        ...
        try {
            ...
            throw new InvalidMimeMailException(INVALID_MIME_MAIL_SEND);
        }
    }
